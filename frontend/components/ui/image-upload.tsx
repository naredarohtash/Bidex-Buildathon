...
export function ImageUpload({
  ...
  const getContainerSize = () => {
    ...
    switch (size) {
      /* `xs` was accepted everywhere else in this file — it thins the padding,
         shrinks the icon and drops the "Max 5MB · JPG, PNG" line — but it had
         no case here, so it fell through to the default and came out the
         tallest of the lot. A field asking for one small portrait was drawing
         a 320px banner. */
      case "xs": return "h-28";
