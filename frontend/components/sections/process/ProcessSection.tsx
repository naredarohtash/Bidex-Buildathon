      ...
      >
        ...
        {showNumbers && (
          <div className="absolute right-3 top-3 select-none pointer-events-none">
            <span
              className="text-5xl font-extrabold leading-none block transition-all duration-500 opacity-[0.08] dark:opacity-[0.12] group-hover:opacity-25 dark:group-hover:opacity-35"
              style={{
                color: gradient.from,
              }}
            >
