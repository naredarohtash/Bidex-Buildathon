        ...
        {isOpen && (
          <>
            ...
            >
              <motion.div
                ref={popupRef}
                className={`relative w-[323px] max-h-[85vh] overflow-hidden rounded-2xl shadow-2xl ${
                  darkMode
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1">
                              {shortcut.keys.map((key, keyIndex) => (
                                <kbd
                                  key={keyIndex}
                                  className={`px-2 py-1 rounded-lg text-[10px] font-mono font-semibold min-w-[27px] text-center ${
                                    darkMode
