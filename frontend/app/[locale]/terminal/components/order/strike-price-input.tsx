  ...
  if (strikeLevels.length === 0) {
    return (
      <div className={`p-3 rounded-lg border ${
        darkMode ? "bg-muted/30 border-border/50" : "bg-gray-100 border-gray-200"
      }`}>
        <p className={`text-xs ${darkMode ? "text-muted-foreground" : "text-gray-500"}`}>
  ...
  return (
    <div className="space-y-2">
        ...
        <button
          ...
          className={`
            ...
            ${selectedDirection === "call"
              ...
              : darkMode
                ? "bg-muted/50 border-border/50 text-muted-foreground border hover:border-border/80"
      ...
      <div className="relative">
        ...
        >
          <div className="flex items-center gap-2">
            {selectedStrikeLevel ? (
              ...
              <span className={`text-sm ${darkMode ? "text-muted-foreground" : "text-gray-400"}`}>
        ...
        {showDropdown && (
          <div className={`
            absolute z-50 w-full mt-1 rounded-lg border overflow-hidden max-h-[190px] overflow-y-auto
            ${
              darkMode
                  ...
                  <div className="flex items-center gap-2 min-w-0">
                    <div className="flex flex-col min-w-0">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className={`text-[10px] font-bold px-1 py-0.5 rounded shrink-0 ${moneyness.bg} ${moneyness.color}`}>
                          {moneyness.label}
                        </span>
                      </div>
                      <span className={`text-[10px] ${
                        ...
                        {formatPrice(price)}
                        <span className={`ml-1 ${darkMode ? "text-muted-foreground" : "text-gray-400"}`}>
      ...
      <div
        className={`flex items-center justify-between text-xs ${
          darkMode ? "text-muted-foreground" : "text-zinc-400"
        }`}
      >
