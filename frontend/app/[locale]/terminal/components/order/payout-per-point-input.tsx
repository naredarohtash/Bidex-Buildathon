          ...
          className={`
            ...
            ${
              isOutOfRange
                ...
                : darkMode
                  ? "bg-muted/50 border border-border/50 text-foreground placeholder-muted-foreground/50"
                  : "bg-white border border-zinc-200 text-foreground placeholder-zinc-400"
            }
      ...
      {suggestedPayouts.length > 0 && (
        <div>
          <div
            ...
            // Note: target line range includes the quick select span:
            // <span className={darkMode ? "text-zinc-600" : "text-zinc-400"}>
            // to replace it too. Let's make sure it wraps properly.
          >
            <span>{t("quick_select")}</span>
            <span className={darkMode ? "text-muted-foreground" : "text-zinc-400"}>
              ...
              return (
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    {potential && (
                      <span className={`text-[10px] ${isSelected ? "text-emerald-400" : "text-emerald-500"}`}>
