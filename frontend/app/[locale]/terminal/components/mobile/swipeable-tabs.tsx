          ...
          {tabs.map((tab, index) => {
            ...
            return (
              <button
                ...
                className={`relative flex flex-col items-center justify-center flex-1 min-h-[46px] py-2 px-3 rounded-lg transition-colors ${
                  isActive
                    ? "text-blue-500"
              ...
              >
                ...
                <div className="relative">
                  ...
                  {tab.badge !== undefined && tab.badge > 0 && (
                    <span className="absolute -top-1 -right-2 min-w-[15px] h-4 px-1 text-[10px] font-bold bg-blue-500 text-white rounded-full flex items-center justify-center">
