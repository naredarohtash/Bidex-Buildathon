  ...
  return (
    <div className="fixed inset-0 bg-zinc-950 flex">
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute top-2 left-2 right-2 flex items-center justify-between pointer-events-none">
          <div className="pointer-events-auto flex items-center gap-3">
            {/* Symbol & Price */}
            <div className="bg-zinc-900/90 rounded-lg px-3 py-1.5">
          ...
          <div className="pointer-events-auto flex items-center gap-1">
            {onExitLandscape && (
              <button
                ...
                className="p-2 bg-zinc-900/90 rounded-lg text-zinc-400 hover:text-white transition-colors"
              >
                <RotateCcw size={16} />
              </button>
            )}
      ...
      <AnimatePresence>
        {isPanelExpanded && (
          <motion.div
            className="w-[114px] bg-zinc-900 border-l border-zinc-800 flex flex-col"
