...
export const ProfileHero = memo(function ProfileHero({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-card via-card to-card/90 border border-border rounded-2xl" />
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute -top-1/4 -right-1/4 w-1/2 h-1/2 rounded-full bg-gradient-to-br from-blue-500/15 to-cyan-500/5 blur-3xl"
        />
        <motion.div
          animate={{
            x: [0, -20, 0],
          ...
          className="absolute -bottom-1/4 -left-1/4 w-1/2 h-1/2 rounded-full bg-gradient-to-tr from-blue-600/15 to-indigo-500/10 blur-3xl"
        />
      </div>
            ...
            <div className="relative group">
              ...
              >
                <Avatar className="h-28 w-28 md:h-32 md:w-32 ring-4 ring-zinc-800 shadow-2xl">
                  ...
                  />
                  <AvatarFallback className="bg-gradient-to-br from-blue-600 to-cyan-500 text-white text-3xl font-semibold">
                    {getUserInitials()}
                  </AvatarFallback>
                </Avatar>
          ...
          >
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      size="icon"
                      onClick={onSettings}
                      className="h-11 w-11 rounded-xl bg-zinc-800/20 border-border hover:bg-zinc-800/50 text-zinc-300"
                    >
            ...
            {currentTab === "security" && (
              <Button
                ...
                className="h-11 px-5 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-semibold shadow-lg shadow-blue-500/25 transition-all hover:shadow-blue-500/40"
              >
