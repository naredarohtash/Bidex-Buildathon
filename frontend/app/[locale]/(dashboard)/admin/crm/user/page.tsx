...
jane.smith@example.com,Jane,Smith,CustomPass123,+0987654321,ACTIVE,false,false,,,Marketing Manager,456 Oak Ave,Los Angeles,USA,90001,,,,,,`;
  ...
  const dataTableProps = useMemo(() => ({
    ...
    columns,
    formConfig,
    /* The edit form opens over the list rather than replacing it. It is five
       short groups, and swapping the whole table out for them lost the row you
       had just clicked — at the same URL, so it read as a page that had
       navigated somewhere it had not. See the data-table's views/form-dialog. */
    formMode: "dialog" as const,
    analytics,
    design: {
