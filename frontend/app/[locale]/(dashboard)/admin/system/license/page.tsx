      ...
      try {
        if (isCore) {
          ...
          setProductInfo({
            ...
            name: "bidex",
            title: response.data?.productName || "BIDEX",
            description: "Complete cryptocurrency exchange platform with spot trading, wallets, and more.",
            type: "core",
            link: "https://bidex.com/item/bidex-crypto-trading-platform-exchange-wallets/35521838",
          });
        } else {
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          {t("purchase_this_product_on_bidex_market")}
                        </p>
                      </div>
                    </div>
                    <a
            ...
            <Card className="overflow-hidden shadow-xl border-2">
              ...
              <CardContent className="p-6 space-y-6">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-1 text-sm">
                          ...
                          <p className="text-muted-foreground">
                            {t("download_your_license_certificate_from_bidex")}{" "}
                ...
                <div className="pt-4 border-t text-center">
                  <a
                    href="https://support.bidex.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code"
                    target="_blank"
                    rel="noopener noreferrer"
