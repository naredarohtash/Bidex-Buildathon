                    ...
                    : transaction.status === "PENDING"
                      ...
                      : transaction.status === "REJECTED"
                        ...
                        : transaction.status === "CANCELLED"
                          ? /* Who cancelled it, in the one line an operator
                               actually reads. A trader can now call off their
                               own pending withdrawal, and "Cancelled" with no
                               author leaves whoever opens this wondering
                               whether somebody on this side did it and forgot
                               to say. The refund is stated too, because the
                               next question after "who" is always "did the
                               money go back". */
                            metadata.cancelledBy === "USER"
                            ? `Cancelled by the account holder${
                                metadata.refunded
                                  ? ` — ${Number(metadata.refunded).toFixed(2)} USDT was returned to their balance`
                                  : ""
                              }.`
                            : "Cancelled."
