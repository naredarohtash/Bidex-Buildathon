...
async function sendWelcomeEmail(instance) {
    try {
        if (!(instance === null || instance === void 0 ? void 0 : instance.email) || instance.emailVerified)
            return;
...
async function assignAccountNumber(instance) {
